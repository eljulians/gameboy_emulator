...
#define SWITCHABLE_RAM_SIZE (SWITCHABLE_RAM_BANK_END - SWITCHABLE_RAM_BANK_START)
...
#define SPRITE_ATTRIBUTES_SIZE (SPRITE_ATTRIBUTES_END - SPRITE_ATTRIBUTES_START)
